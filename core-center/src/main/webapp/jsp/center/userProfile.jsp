...
<head>
    ...
    <script type="text/javascript"
            src="http://wawaonline.net:80/corecenter/js/third-party/jquery-2.1.1.min.js"></script>
    <script type="text/javascript" src="http://wawaonline.net:80/corecenter/js/gamecenter.js"></script>
    <script type="text/javascript" src="http://wawaonline.net:80/corecenter/js/test.js"></script>
    <script type="text/javascript">
        function deviceList() {
