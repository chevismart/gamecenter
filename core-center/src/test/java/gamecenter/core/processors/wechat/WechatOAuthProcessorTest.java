...
public class WechatOAuthProcessorTest {
    ...
    public void oauthUrlGeneration() throws Exception {
        ...
        String oauthUrl = "https://open.weixin.qq.com/connect/oauth2/authorize?" +
                ...
                "state=%s" +
                "#wechat_redirect";
        String expected = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=chevisappid&redirect_uri=http://alcock.gicp.net:8888/auth&response_type=code&scope=snsapi_userinfo&state=appid:chevisappid,device:abcd1234#wechat_redirect";
