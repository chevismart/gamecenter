...
//        PowerMockito.when(LocalHttpClient.execute(any(HttpUriRequest.class))).thenReturn(httpResponse);
//        when(httpResponse.getEntity()).thenReturn(httpEntity);
//        PowerMockito.when(EntityUtils.toString(httpEntity)).thenReturn(json);
//
